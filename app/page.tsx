...
const logoStyles = [
  { name: "Тех", icon: "/tech.svg" },
  { name: "Яркий", icon: "/flashy.svg" },
  { name: "Модерн", icon: "/modern.svg" },
  { name: "Игривый", icon: "/playful.svg" },
  { name: "Абстракт", icon: "/abstract.svg" },
  { name: "Минимализм", icon: "/minimal.svg" },
];

const primaryColors = [
  { name: "Синий", color: "#0F6FFF" },
...
*/
  ...
  return (
    <div className="flex h-screen flex-col overflow-y-auto overflow-x-hidden bg-[#141414] md:flex-row">
      <Header className="block md:hidden" />

      <div className="flex w-full flex-col md:flex-row">
        <div className="relative flex h-full w-full flex-col bg-[#141414] text-[#F3F3F3] md:max-w-sm">
          <form
            onSubmit={(e) => {
              e.preventDefault();
              setGeneratedImage("");
            ...
            <fieldset className="flex grow flex-col" disabled={!isSignedIn}>
                ...
                <div className="px-8 pb-0 pt-4 md:px-6 md:pt-6">
                  ...
                  */}
                  ...
                  <div className="mb-6">
                    <label className="mb-2 flex items-center text-xs font-bold uppercase text-[#6F6F6F]">
                      СТИЛЬ
                      <InfoTooltip content="Выберите стиль вашего лого" />
                    </label>
                    <RadioGroup.Root
                      value={selectedStyle}
                    ...
                    <div className="mt-1">
                      <div className="mb-1">
                        ...
                        >
                          ...
                          <InfoTooltip content="Введите любые пожелания для вашего лого" />
                        </label>
                        <Textarea
              ...
              <div className="px-8 py-4 md:px-6 md:py-6">
                ...
                >
                  ...
                  {isLoading ? "Загрузка..." : "Создать Лого"}{" "}
                </Button>
              </div>
            </fieldset>
          </form>
          ...
          {isLoaded && !isSignedIn && (
            ...
            >
              <div className="rounded bg-gray-200 p-4 text-gray-900">
                <p className="text-lg">
                  Создайте бесплатный аккаунт, чтобы начать создавать лого:
                </p>
            ...
            <div className="relative aspect-square w-full max-w-lg">
              {generatedImage ? (
                ...
                <Spinner loading={isLoading} className="size-8 text-white">
                  <div className="flex aspect-square w-full flex-col items-center justify-center rounded-xl bg-[#1C1C1C]">
                    <h4 className="text-center text-base leading-tight text-white">
                      Создайте лого вашей мечты
                      <br />
                      всего за 10 секунд!
                    </h4>
                  </div>
